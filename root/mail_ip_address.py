...
# Account Information
to = 'tamim.tm@gmail.com' # Email to send to.
gmail_user = 'datasoft.iot@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'Tamim123' # Gmail password.
...
localtime = time.strftime("%H:%M:%S %Z")
text = 'At %s ' % localtime
...
msg = MIMEText(text + "\n" + my_ip_a + "\n" + my_ip_b)
msg['Subject'] = 'IPs For Edison on %s' % today.strftime('%b %d %Y')
msg['From'] = gmail_user
msg['To'] = to
# Sends the message
